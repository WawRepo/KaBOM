...
| | When | Example |
|---|---|---|
| 🟢 | oldest < 24h, nothing failed | `Updated 20 minutes ago · 30 of 30 read` |
| 🟡 | oldest 24h–7d | `Updated 2 days ago · 30 of 30 read` |
| 🔴 | oldest ≥ 7d, age unknown, **or** any file failed to parse | `STALE — oldest data is 39 days old · 28 of 30 read` |
