...
KaBOM only ever reads CycloneDX JSON produced by Syft. This module
has no opinion about vulnerabilities or policy — it extracts exactly what the
search feature and the freshness banner need: the
...
class ParsedSBOM:
    ...
    anything downstream that computes data age (the freshness banner).
    """
